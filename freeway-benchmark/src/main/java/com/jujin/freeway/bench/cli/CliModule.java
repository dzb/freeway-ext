...
/**
 * Registers all CLI command implementations as contributions. New commands are added to {@link
 * #bind(Binder)}.
 */
public final class CliModule implements ModuleEx {
  ...
  public void bind(Binder binder) {
    ...
    binder.contribute(RuntimeHook.class).add("freeway.http.server", c -> {});
  }
