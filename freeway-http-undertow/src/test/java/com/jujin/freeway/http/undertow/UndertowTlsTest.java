...
/** TLS startup contract test for the Undertow adapter. */
class UndertowTlsTest {
  ...
  private static Path keystorePath() {
    try {
      return Path.of(UndertowTlsTest.class.getResource("/freeway-test-keystore.p12").toURI());
    } catch (Exception ex) {
